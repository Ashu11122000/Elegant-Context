  ...
  const sectionHighlights = [
    {
      ...
      description:
        "Luxury-designed products created with exceptional attention to detail.",
    },
    {
      icon: FiTrendingUp,
      title: "Trending Collections",
      description:
        "Discover fashion-forward essentials loved by modern luxury shoppers.",
    },
    {
      icon: FiStar,
      title: "Most Loved Picks",
      description:
        "Hand-selected premium pieces consistently admired by our customers.",
    },
  ];

  return (
    <section className="relative overflow-hidden bg-[#0f0d09] py-20 md:py-28">
      {/* Luxury Background */}
      ...
      {/* Glow Effects */}
      <div className="absolute left-[-120px] top-10 h-[260px] w-[260px] rounded-full bg-amber-500/10 blur-3xl" />

      <div className="absolute bottom-[-120px] right-[-100px] h-[260px] w-[260px] rounded-full bg-yellow-500/10 blur-3xl" />
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col gap-10 lg:flex-row lg:items-end lg:justify-between">
          <div className="max-w-3xl">
            <SectionHeading
              ...
              title="Luxury Picks Curated for Modern Elegance"
              subtitle="Explore premium fashion essentials crafted with refined sophistication, timeless style, and elevated luxury aesthetics designed for modern lifestyles."
              align="left"
            />
        ...
        {featuredProducts.length > 0 ? (
          <>
            <div className="mt-16 grid grid-cols-1 gap-7 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
          ...
          <div className="mt-16">
            <EmptyState
              ...
              message="We are currently refreshing our premium featured collections for an even more elevated luxury shopping experience."
            />
          </div>
        )}
          ...
          <div className="relative mt-20 overflow-hidden rounded-[40px] border border-white/10 bg-gradient-to-br from-[#241706] via-[#33220d] to-[#4a3110] px-6 py-14 shadow-[0_25px_70px_rgba(0,0,0,0.35)] sm:px-10">
            ...
            <div className="relative z-10 text-center">
              ...
              <div className="inline-flex items-center gap-3 rounded-full border border-amber-400/20 bg-black/20 px-5 py-2.5 backdrop-blur-xl">
                <FiStar className="text-sm text-amber-300" />
              ...
              <h3 className="mx-auto mt-6 max-w-4xl font-serif text-3xl font-black leading-tight tracking-tight text-[#f8f1e8] sm:text-5xl">
                Explore Exclusive Luxury Collections Designed for Sophisticated Style
              </h3>

              {/* Description */}
              <p className="mx-auto mt-6 max-w-2xl text-sm leading-[1.9] text-stone-300 sm:text-base">
                Shop refined premium collections crafted with timeless elegance,
                elevated craftsmanship, and luxurious detailing tailored for
